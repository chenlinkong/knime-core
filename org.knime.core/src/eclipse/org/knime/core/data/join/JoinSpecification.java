...
public class JoinSpecification {
    ...
    private DataTableSpec specForNormalMatchTable() {
        ...
        final HashSet<String> takenNames = new HashSet<>(getSettings(InputTable.LEFT).getIncludeColumnNames());
    ...
    private DataTableSpec specForMergedMatchTable() {
        ...
        final HashSet<String> leftIncludes = new HashSet<>(getSettings(InputTable.LEFT).getIncludeColumnNames());
        final HashSet<String> leftJoinColumns = new HashSet<>(getSettings(InputTable.LEFT).getJoinColumnNames());

        // create a data structure for fast lookup of already used (thus reserved) column names
        final HashSet<String> takenNames = new HashSet<>();
